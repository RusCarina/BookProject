...
public class AudioBookRepositoryMySQL implements AudioBookRepository{
    ...
    public Optional<AudioBook> findById(Long id) {
        ...
        Optional<AudioBook> book = Optional.empty();
    ...
    public boolean save(AudioBook book) {
        ...
        String newSql = "INSERT INTO audiobook VALUES(null, \'" + book.getAuthor() +"\', \'"+ book.getTitle()+"\', null );";
...
//            return true;
    ...
    public void removeAll() {
        String sql = "DELETE FROM audiobook WHERE id >= 0;";
